...
export class ProjectsService {
  projects: Project[] = [
    {id: 0, name: "Lost Duckling", description: "Puzzle game", platforms: "Apple App Store and Google Play.", role: "Game Designer, Game Programmer, and Project Lead.",
     toolsUsed: "Unity, C#, Azure DevOps, Git, Photoshop, and Draw.IO.", imagePath: "../../assets/Lost Duckling.png", routerLink: "/home/lost-duckling",
    ...
    toolsUsed: "Unity, C#, Azure DevOps, Git, and Draw.IO.", imagePath: "../../assets/Fallen Umbrella.png", routerLink: "/home/fallen-umbrella",
    ...
    toolsUsed: "Unity, C#, Azure DevOps, and Git.", imagePath: "../../assets/Monster Cleaning.png", routerLink: "/home/monster-cleaning", 
    ...
    {id: 3, name: "Aliens Defense", description: "Tap defense", platforms: "Apple App Store and Google Play.", role: "Game Designer and Game Programmer.",
     toolsUsed: "Unity, C#, Azure DevOps, Git, and Excel.", imagePath: "../../assets/Aliens Defense.png", routerLink: "/home/aliens-defense", 
    ...
    toolsUsed: "Unity, C#, Azure DevOps, and Git.", imagePath: "../../assets/Hood Search.png", routerLink: "/home/hood-search",
    ...
    toolsUsed: "Unity, C#, Azure DevOps, Git, and Draw.IO.", imagePath: "../../assets/An Elf's Tune.png", routerLink: "/home/an-elfs-tune", 
    ...
    toolsUsed: "Unity, C#, Azure DevOps, and Git.", imagePath: "../../assets/House Cat.png", routerLink: "/home/house-cat", summary: "This was the first game Alex ever made. The player taps either the left or right half of the screen to move the cat.",
    ...
    toolsUsed: "Unity, C#, Azure DevOps, Git, and Draw.IO.", role: "Game Designer and Game Programmer.",  routerLink: "/home/battle-ship",
