...
export class ProjectsService {
  projects: Project[] = [
    {id: 0, name: "Turtle Trot", description: "Race your Turtle!", platforms: "Apple and Android devices.", role: "Game Designer and Game Programmer.",
      toolsUsed: "Unity, C#, Azure DevOps, and Git.", imagePath: "../../assets/Turtle Trot.png", routerLink: "/games/turtle-trot",
        summary: "Choose a Turtle Size, Starting Position, and get ready to Race.", youtubeLink: "https://www.youtube.com/embed/E0GehuLAxZk", appleAppStoreLink: "https://apps.apple.com/us/app/turtle-trot/id6478960755", 
        googlePlayLink: "https://play.google.com/store/apps/details?id=com.Mobazy.TurtleTrot", releasedOnAppStores: true, youtubeHeight: "560", youtubeWidth: "315"},

    {id: 1, name: "Lost Duckling", description: "Puzzle game", platforms: "Apple and Android devices.", role: "Game Designer, Game Programmer, and Project Lead.",
    ...
    {id: 2, name: "Fallen Umbrella", description: "Platformer", platforms: "Apple and Android devices.", role: "Game Designer and Game Programmer.",
    ...
    {id: 3, name: "Monster Cleaning", description: "First person shooter", platforms: "Apple and Android devices.", role: "Game Programmer.",
    ...
    {id: 4, name: "Aliens Defense", description: "Tap defense", platforms: "Apple and Android devices.", role: "Game Designer and Game Programmer.",
    ...
    {id: 5, name: "Hood Search", description: "Find the hidden objects", platforms: "Apple and Android devices.", role: "Game Designer and Game Programmer.",
    ...
    {id: 6, name: "Bear Feeding", description: "Feed the Bears!", platforms: "Apple and Android devices.", role: "Game Designer and Game Programmer.",
